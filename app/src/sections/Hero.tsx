  ...
  return (
    ...
    >
      ...
      >
        ...
        {(heroConfig.titleLine || heroConfig.titleEmphasis || heroConfig.subtitleLine1 || heroConfig.subtitleLine2) && (
          <h1
            ref={titleRef}
            style={{
          ...
          >
            {heroConfig.titleLine && <div>{heroConfig.titleLine}</div>}
            {heroConfig.titleEmphasis && (
              <div><em style={{ fontStyle: 'italic' }}>{heroConfig.titleEmphasis}</em></div>
            )}
            {heroConfig.subtitleLine1 && (
              <div style={{
                fontFamily: 'Inter, system-ui, sans-serif',
                ...
                opacity: 0.7,
                color: '#D4A574',
              }}>{heroConfig.subtitleLine1}</div>
            )}
          </h1>
        )}

        {/* We no longer use the old subtitle/paragraph format */}
        {false && null}
